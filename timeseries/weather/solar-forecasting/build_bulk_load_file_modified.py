...
raw_input_weather_file = 'weather_summer_2013_modified.txt'
bulk_load_output_file = 'ghi_dhi_bulkload_modified.txt'
measurement = "weather"
database = "proven"
...
with open(raw_input_weather_file) as fin:
    for line in fin:
        ...
        if (count > 2):
            ...
            p='%I:%M %p'
            dt_temp = data_tokens[2]
            data_tokens[2] = (time.strftime('%H:%M', time.strptime(data_tokens[2],p)))
